...
<div class="lg:container mx-auto h-full w-full p-8">
	<form method="POST" action="/" class="flex flex-col items-center w-full justify-center">
		...
		<div class="form-control w-full max-w-xs">
			...
			<input type="email" name="email" class="input w-full max-w-xs  {form?.errors?.email ? 'input-error' : 'input-bordered'}" value={form?.data.email ?? ''} />
			<label for="email" class="label">
		...
		<div class="form-control w-full max-w-xs">
			...
			<input type="password" name="password" class="input w-full max-w-xs  {form?.errors?.password ? 'input-error' : 'input-bordered'}" />
			<label for="password" class="label">
		...
		<div class="form-control w-full max-w-xs">
			...
			<input type="password" name="passwordConfirm" class="input w-full max-w-xs  {form?.errors?.passwordConfirm ? 'input-error' : 'input-bordered'}" />
			<label for="passwordConfirm" class="label">
		...
		<div class="form-control w-full max-w-xs pb-2">
			<label class="label cursor-pointer justify-start space-x-4">
				<input type="checkbox" name="terms" class="checkbox checkbox-primary {form?.errors?.terms ? 'border-error' : ''}" />
